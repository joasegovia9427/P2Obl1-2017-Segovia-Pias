...
//Despliega y lee la opcion para el menu principal de 4 opciones
void menusPROC_menuPrincipal(int &opcion);

//Despliega y lee la opcion para el menu secundaro (de la opcion 3 del menu principal), de 8 opciones
void menusPROC_menuOpcion3(int &opcion3);

//Seccion mensajes respecto a menu

//Mensaje para indicar segun la flag, para la opcion 2 y 3 del menu principal
